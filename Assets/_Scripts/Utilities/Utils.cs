...
public class Utils
{
    public static NormalItem.eNormalType GetRandomNormalType()
    {
        ...
        NormalItem.eNormalType result = (NormalItem.eNormalType)values.GetValue(URandom.Range(0, GetNormalTypeCount()));
    ...
    public static int GetNormalTypeCount()
    {
        return Enum.GetValues(typeof(NormalItem.eNormalType)).Length;
    }
}
