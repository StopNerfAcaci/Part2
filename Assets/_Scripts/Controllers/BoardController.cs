...
public class BoardController : MonoBehaviour
{
    ...
    delegate void mouseClickHandle();
    ...
    public void Update()
    {
        ...
        if (Input.GetMouseButtonDown(0))
        {
            ...
            if (hit.collider != null)
            {
                ...
                if (cell.IsCheckCell)
                {
                    Debug.LogWarning("Cannot assign from check cell");
                    return;
                }

                m_board.AssignToMatchCell(cell);
            }
        }
    ...
    public void OperateAutoPlay()
    {

    }
    public void OperateAutoLose()
    {
    ...
    public bool IsWinGame() => m_board.IsClearBoard();
    public bool IsLoseGame() => m_board.IsCheckedFull();
}
